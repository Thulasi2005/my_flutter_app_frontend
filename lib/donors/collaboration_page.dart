...
class _CollaborationPageState extends State<CollaborationPage> {
  ...
  Future<void> _fetchCollaborationDetails() async {
    final url = 'http://10.0.2.2/donation_app/get_collaboration_details.php'; // Update with your actual backend URL
  ...
  Future<void> _confirmSelection() async {
    final url = 'http://10.0.2.2/donation_app/confirm_selection.php'; // Update with your actual backend URL
